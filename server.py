...
def plot_DashBoard(
    df, fig_sunburst_pos, fig_sunburst_neg, fig_waterfall, fig_sankey, unit
):
    app = Dash(
    ...
    method = "IPCC GWP100y"
    methods = ["IPCC GWP100y", "Fake", "array"]
